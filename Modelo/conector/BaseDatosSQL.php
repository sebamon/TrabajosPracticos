<?php
class BaseDatosSQL extends PDO {
    ...
    public function __construct(){
        $this->engine = 'sqlsrv:Server';
        $this->host = '172.18.80.30';
        $this->database = 'edersaglm';
        $this->user = 'smon';
        $this->pass = 'muchabirra';
        $this->debug = true;
        $this->error ="";
        $this->sql ="";
        $this->indice =0;
        
      //  $conn = new PDO("sqlsrv:Server=172.18.80.30;Database=edersaglm", "Smon", "muchabirra");
       // $serverName = "172.18.80.30\sqlserver"; //serverName\instanceName
   // $connectionInfo = array( "Database"=>"edersaglm", "UID"=>"smon", "PWD"=>"muchabirra");
//$conn = sqlsrv_connect( $serverName, $connectionInfo);

$serverName = "172.18.80.30";   
$database = "EDERSA_COMERCIAL_PROD";  
...
if( $conn ) {
     ...
     //   $dns = $this->engine.':dbname='.$this->database.";host=".$this->host;
        try {
           // $c = new PDO("sqlsrv:Server=172.18.80.30,1521;Database=edersaglm", "smon", "muchabirra");
        //   parent::__construct( $dns, $this->user, $this->pass,array( PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION => 'SET NAMES utf8'));
           $this->conn=true;
        }catch (PDOException $e) {
